    ...
    public class _LL41_25_26_DeriveAndWrapKeyTest
    {
        ...
        public void _LL41_25_26_01_DeriveAndWrap_VKO_Gost3410_01_Test()
        {
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                rv = Helpers.DeriveKey(pkcs11, session, recipientPubKeyId, senderPrivKeyId, ukm, ref senderDerivedKeyId);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
                ...
                rv = Helpers.DeriveKey(pkcs11, session, senderPubKeyId, recipientPrivKeyId, ukm, ref recipientDerivedKeyId);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
