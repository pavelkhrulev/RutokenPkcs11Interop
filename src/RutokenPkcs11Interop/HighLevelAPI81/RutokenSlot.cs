...
namespace Net.RutokenPkcs11Interop.HighLevelAPI81
{
    public class RutokenSlot : Net.Pkcs11Interop.HighLevelAPI81.Slot, IRutokenSlot
    {
        ...
        public ITokenInfoExtended GetTokenInfoExtended()
        {
            ...
            {
                SizeofThisStructure = Convert.ToUInt32(Marshal.SizeOf(typeof(LowLevelAPI81.CK_TOKEN_INFO_EXTENDED)))
            };
        ...
        public void SetLocalPIN(string userPin, string localPin, ulong localPinId)
        {
            ...
            CKR rv = ((LowLevelAPI81.RutokenPkcs11Library)_pkcs11Library).C_EX_SetLocalPIN(_slotId, userPinArray, localPinArray, localPinId);
            if (rv != CKR.CKR_OK)
        ...
        {
            CKR rv = ((LowLevelAPI81.RutokenPkcs11Library)_pkcs11Library).C_EX_SetLocalPIN(_slotId, null, null, pinId);
            if (rv != CKR.CKR_OK)
                throw new Pkcs11Exception("C_EX_SetLocalPIN", rv);
        }
            ...
            string pin, IEnumerable<IVolumeFormatInfoExtended> initParams)
        {
            ...
            CKR rv = ((LowLevelAPI81.RutokenPkcs11Library)_pkcs11Library).C_EX_FormatDrive(_slotId, (ulong)userType,
            ...
            ulong volumeId, FlashAccessMode newAccessMode, bool permanent)
        {
            ...
            CKR rv = ((LowLevelAPI81.RutokenPkcs11Library)_pkcs11Library).C_EX_ChangeVolumeAttributes(_slotId, (ulong)userType,
        ...
        public void SlotManage(ulong mode, byte[] value)
        {
            ...
            try
            {
                CKR rv = ((LowLevelAPI81.RutokenPkcs11Library)_pkcs11Library).C_EX_SlotManage(_slotId, mode, valuePtr);
                if (rv != CKR.CKR_OK)
