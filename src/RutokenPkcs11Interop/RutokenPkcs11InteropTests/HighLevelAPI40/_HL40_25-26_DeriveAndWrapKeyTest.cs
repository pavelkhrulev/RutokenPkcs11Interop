...
using RutokenPkcs11Interop.HighLevelAPI40.MechanismParams;

namespace RutokenPkcs11InteropTests.HighLevelAPI40
{
    [TestFixture()]
    public class _HL40_25_26_DeriveAndWrapKeyTest
    {
        [Test()]
        public void _HL40_25_26_01_DeriveAndWrap_VKO_Gost3410_01_Test()
        {
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath, AppType.MultiThreaded))
            {
                ...
                using (Session session = slot.OpenSession(SessionType.ReadWrite))
                {
                    ...
                    Mechanism wrapMechanism = new Mechanism((uint) Extended_CKM.CKM_GOST28147_KEY_WRAP,
                        wrapMechanismParams);
        ...
        [Test()]
        public void _HL40_25_26_02_DeriveAndWrap_VKO_Gost3410_12_Test()
        {
            if (Platform.UnmanagedLongSize != 4 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        [Test()]
        public void _HL40_25_26_03_ExtendedWrap_VKO_Gost3410_12_Test()
        {
            if (Platform.UnmanagedLongSize != 4 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
