...
{
    [TestFixture()]
    public class _HL80_09_InitTokenAndPinTest
    {
        /// <summary>
        /// Basic C_InitToken and C_InitPIN test.
        /// </summary>
        [Test()]
        public void _HL80_09_01_BasicInitTokenAndPinTest()
        {
        ...
        [Test()]
        public void _HL80_09_02_ExtendedInitTokenAndPinTest()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        [Test()]
        public void _HL80_09_03_ExtendedInitTokenRepairModeTest()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
