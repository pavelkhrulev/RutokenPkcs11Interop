...
{
    [TestFixture()]
    public class _HL80_20_EncryptAndDecryptTest
    {
        /// <summary>
        /// C_EncryptInit, C_Encrypt, C_DecryptInit and C_Decrypt test.
        /// </summary>
        [Test()]
        public void _HL80_20_01_EncryptAndDecrypt_Gost28147_89_ECB_Test()
        {
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath, AppType.MultiThreaded))
            {
                ...
                using (Session session = slot.OpenSession(SessionType.ReadWrite))
                {
                    ...
                    Mechanism mechanism = new Mechanism((ulong) Extended_CKM.CKM_GOST28147_ECB);
        ...
        /// </summary>
        [Test()]
        public void _HL80_20_02_EncryptAndDecrypt_Gost28147_89_Stream_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath, AppType.MultiThreaded))
            {
                ...
                using (Session session = slot.OpenSession(SessionType.ReadWrite))
                {
                    ...
                    Mechanism mechanism = new Mechanism((ulong)Extended_CKM.CKM_GOST28147);
        ...
        /// </summary>
        [Test()]
        public void _HL80_20_03_EncryptAndDecrypt_Gost28147_89_CBC_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        /// </summary>
        [Test()]
        public void _HL80_20_04_EncryptAndDecrypt_RSA_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
