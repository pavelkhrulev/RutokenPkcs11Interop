...
namespace RutokenPkcs11InteropTests.HighLevelAPI80
{
    ...
    /// </summary>
    [TestFixture()]
    public class _HL80_35_PinPolicyTest
    {
        ...
        /// </summary>
        [Test()]
        public void _HL80_35_01_SupportsPinPolicy_Test()
        {
        ...
        /// </summary>
        [Test()]
        public void _HL80_35_02_GetPinPolicy_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        /// </summary>
        [Test()]
        public void _HL80_35_03_SetPinPolicy_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
