...
namespace RutokenPkcs11InteropTests.HighLevelAPI80
{
    ...
    /// </summary>
    [TestFixture()]
    public class _HL80_12_DigestTest
    {
        /// <summary>
        /// C_DigestInit and C_Digest test.
        /// </summary>
        [Test()]
        public void _HL80_12_01_Digest_SHA1_Test()
        {
        ...
        /// </summary>
        [Test()]
        public void _HL80_12_02_Digest_Gost3411_12_512_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        /// </summary>
        [Test()]
        public void _HL80_12_03_Digest_Gost3411_12_256_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        /// </summary>
        [Test()]
        public void _HL80_12_04_Digest_Gost3411_94_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
