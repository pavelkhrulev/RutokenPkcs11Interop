...
namespace RutokenPkcs11InteropTests.LowLevelAPI81
{
    public static class Helpers
    {
        ...
        public static void GenerateGostSymmetricKey(Pkcs11 pkcs11, ulong session, ref ulong keyId)
        {
            ...
            CK_MECHANISM mechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOST28147_KEY_GEN);
            ...
            string keyPairId)
        {
            ...
            CK_MECHANISM mechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3410_KEY_PAIR_GEN);
            ...
            string keyPairId)
        {
            ...
            privateKeyTemplate[2] = CkaUtils.CreateAttribute(CKA.CKA_ID, keyPairId);
            privateKeyTemplate[3] = CkaUtils.CreateAttribute(CKA.CKA_KEY_TYPE, (ulong)Extended_CKK.CKK_GOSTR3410_512);
            privateKeyTemplate[4] = CkaUtils.CreateAttribute(CKA.CKA_TOKEN, true);
            privateKeyTemplate[5] = CkaUtils.CreateAttribute(CKA.CKA_PRIVATE, true);
            privateKeyTemplate[6] = CkaUtils.CreateAttribute(CKA.CKA_DERIVE, true);
            ...
            CK_MECHANISM mechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3410_512_KEY_PAIR_GEN);
        ...
        public static void GenerateGost512JournalKeyPair(Pkcs11 pkcs11, ulong session, ref ulong publicKeyId, ref ulong privateKeyId)
        {
            ...
            publicKeyTemplate[0] = CkaUtils.CreateAttribute(CKA.CKA_CLASS, CKO.CKO_PUBLIC_KEY);
            publicKeyTemplate[1] = CkaUtils.CreateAttribute(CKA.CKA_KEY_TYPE, (ulong)Extended_CKK.CKK_GOSTR3410_512);
            ...
            publicKeyTemplate[4] = CkaUtils.CreateAttribute((ulong)Extended_CKA.CKA_VENDOR_KEY_JOURNAL, true);

            // Шаблон для генерации закрытого ключа ГОСТ Р 34.10-2012
            var privateKeyTemplate = new CK_ATTRIBUTE[6];
            privateKeyTemplate[0] = CkaUtils.CreateAttribute(CKA.CKA_CLASS, CKO.CKO_PRIVATE_KEY);
            privateKeyTemplate[1] = CkaUtils.CreateAttribute(CKA.CKA_KEY_TYPE, (ulong)Extended_CKK.CKK_GOSTR3410_512);
            ...
            privateKeyTemplate[4] = CkaUtils.CreateAttribute((ulong)Extended_CKA.CKA_VENDOR_KEY_JOURNAL, true);
            privateKeyTemplate[5] = CkaUtils.CreateAttribute((ulong)Extended_CKA.CKA_VENDOR_KEY_CONFIRM_OP, false);
            ...
            byte[] ukm, ref ulong derivedKeyId)
        {
            ...
            CK_MECHANISM deriveMechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3410_DERIVE, deriveMechanismParams);
            ...
            byte[] ukm, ref ulong derivedKeyId)
        {
            ...
            // Определяем механизм выработки ключа
            CK_MECHANISM deriveMechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3410_12_DERIVE, deriveMechanismParams);
            ...
            byte[] initVector, ulong keyId)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                for (var i = 0; i < dataWithPadding.Length / Settings.GOST28147_89_BLOCK_SIZE; i++)
                {
                    ...
                    ulong blockLength = Convert.ToUInt64(block.Length);
            ...
            byte[] data, byte[] initVector, ulong keyId)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                for (var i = 0; i < data.Length / Settings.GOST28147_89_BLOCK_SIZE; i++)
                {
                    ...
                    ulong blockLength = Convert.ToUInt64(currentData.Length);
