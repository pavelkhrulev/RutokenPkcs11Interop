...
namespace RutokenPkcs11InteropTests.LowLevelAPI80
{
    ...
    /// </summary>
    [TestFixture()]
    public class _LL80_20_EncryptAndDecryptTest
    {
        /// <summary>
        /// C_EncryptInit, C_Encrypt, C_DecryptInit and C_Decrypt test.
        /// </summary>
        [Test()]
        public void _LL80_20_01_EncryptAndDecrypt_Gost28147_89_ECB_Test()
        {
        ...
        /// </summary>
        [Test()]
        public void _LL80_20_02_EncryptAndDecrypt_Gost28147_89_Stream_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        /// </summary>
        [Test()]
        public void _LL80_20_03_EncryptAndDecrypt_Gost28147_89_CBC_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        [Test()]
        public void _LL80_20_04_EncryptAndDecrypt_RSA_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
