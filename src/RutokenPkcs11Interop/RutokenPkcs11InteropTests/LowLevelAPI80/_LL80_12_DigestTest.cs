...
namespace RutokenPkcs11InteropTests.LowLevelAPI80
{
    ...
    /// </summary>
    [TestFixture()]
    public class _LL80_12_DigestTest
    {
        /// <summary>
        /// C_DigestInit and C_Digest test.
        /// </summary>
        [Test()]
        public void _LL80_12_01_Digest_SHA1_Test()
        {
        ...
        /// </summary>
        [Test()]
        public void _LL80_12_02_Digest_Gost3411_12_512_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                // Specify digesting mechanism (needs no parameter => no unamanaged memory is needed)
                CK_MECHANISM mechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3411_12_512);
        ...
        /// </summary>
        [Test()]
        public void _LL80_12_03_Digest_Gost3411_12_256_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                // Specify digesting mechanism (needs no parameter => no unamanaged memory is needed)
                CK_MECHANISM mechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3411_12_256);
        ...
        /// </summary>
        [Test()]
        public void _LL80_12_04_Digest_Gost3411_94_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
            ...
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                // Specify digesting mechanism (needs no parameter => no unamanaged memory is needed)
                CK_MECHANISM mechanism = CkmUtils.CreateMechanism((ulong)Extended_CKM.CKM_GOSTR3411);
