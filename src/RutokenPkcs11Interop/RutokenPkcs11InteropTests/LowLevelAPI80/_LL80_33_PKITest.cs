...
{
    [TestFixture()]
    public class _LL80_33_PKITest
    {
        [Test()]
        public void _LL80_33_01_CreateCSR_PKCS10Test()
        {
        ...
        [Test()]
        public void _LL80_33_02_ImportCertificateTest()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
            ...
            using (var pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath))
            {
                ...
                // Импорт сертификата
                ulong certificateId = CK.CK_INVALID_HANDLE;
