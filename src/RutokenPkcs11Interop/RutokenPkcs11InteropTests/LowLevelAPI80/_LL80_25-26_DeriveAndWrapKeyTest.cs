...
{
    [TestFixture()]
    public class _LL80_25_26_DeriveAndWrapKeyTest
    {
        [Test()]
        public void _LL80_25_26_01_DeriveAndWrap_VKO_Gost3410_01_Test()
        {
            ...
            using (var pkcs11 = new RutokenPkcs11Library(Settings.Pkcs11LibraryPath))
            {
                ...
                ulong senderPubKeyId = CK.CK_INVALID_HANDLE;
                ulong senderPrivKeyId = CK.CK_INVALID_HANDLE;
                ...
                ulong recipientPubKeyId = CK.CK_INVALID_HANDLE;
                ulong recipientPrivKeyId = CK.CK_INVALID_HANDLE;
                ...
                ulong senderDerivedKeyId = CK.CK_INVALID_HANDLE;
                ...
                sessionKeyTemplate[2] = CkaUtils.CreateAttribute(CKA.CKA_KEY_TYPE, (ulong)Extended_CKK.CKK_GOST28147);
                ...
                ulong recipientDerivedKeyId = CK.CK_INVALID_HANDLE;
                ...
                unwrappedKeyTemplate[2] = CkaUtils.CreateAttribute(CKA.CKA_KEY_TYPE, (ulong)Extended_CKK.CKK_GOST28147);
        ...
        [Test()]
        public void _LL80_25_26_02_DeriveAndWrap_VKO_Gost3410_12_Test()
        {
            if (Platform.NativeULongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        [Test()]
        public void _LL80_25_26_03_ExtendedWrap_VKO_Gost3410_12_Test()
        {
            if (Platform.NativeULongSize != 8 || Platform.StructPackingSize != 0)
                Assert.Inconclusive("Test cannot be executed on this platform");
            ...
            using (RutokenPkcs11Library pkcs11 = new RutokenPkcs11Library(Settings.Pkcs11LibraryPath))
            {
                ...
                ulong sessionKeyId = CK.CK_INVALID_HANDLE;
                ulong wrappedKeyLen = 0;
                rv = pkcs11.C_EX_WrapKey(session, ref generationMechanism, sessionKeyTemplate, (ulong)sessionKeyTemplate.Length,
                ...
                // Демаскирование сессионного ключа с помощью общего выработанного
                // ключа на стороне получателя
                ulong unwrappedKeyId = CK.CK_INVALID_HANDLE;
                rv = pkcs11.C_EX_UnwrapKey(session, ref derivationMechanism, recipientPrivKeyId,
                    ref wrappingMechanism, wrappedKey, wrappedKeyLen, unwrappedKeyTemplate, (ulong)unwrappedKeyTemplate.Length,
                    ref unwrappedKeyId);
                if (rv != CKR.CKR_OK)
                    Assert.Fail(rv.ToString());
