...
namespace RutokenPkcs11InteropTests.HighLevelAPI81
{
    ...
    /// </summary>
    [TestFixture()]
    public class _HL81_35_PinPolicyTest
    {
        ...
        /// </summary>
        [Test()]
        public void _HL81_35_01_SupportsPinPolicy_Test()
        {
        ...
        /// </summary>
        [Test()]
        public void _HL81_35_02_GetPinPolicy_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 1)
                Assert.Inconclusive("Test cannot be executed on this platform");
        ...
        /// </summary>
        [Test()]
        public void _HL81_35_03_SetPinPolicy_Test()
        {
            if (Platform.UnmanagedLongSize != 8 || Platform.StructPackingSize != 1)
                Assert.Inconclusive("Test cannot be executed on this platform");
